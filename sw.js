const CACHE='netto-tools-v5';
const CORE=['./','./index.html','./home.html','./articles.html','./planning.html','./chat.html','./profile.html','./settings.html','./stock-test.html','./manifest.webmanifest','./design-v2.css','./profile-ui.js?v=4','./assets/app-icon.svg','./assets/logo-stock.svg','./assets/logo-planning.svg','./assets/logo-equipe.svg'];
