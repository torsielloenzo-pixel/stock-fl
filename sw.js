const CACHE='netto-tools-v1';
const CORE=['./','./index.html','./home.html','./articles.html','./planning.html','./chat.html','./profile.html','./settings.html','./stock-test.html','./manifest.webmanifest','./assets/app-icon.svg','./assets/logo-stock.svg','./assets/logo-planning.svg','./assets/logo-equipe.svg'];
