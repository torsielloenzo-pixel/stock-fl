...
function addStyle(){
 ...
 :root[data-theme="dark"] .nettoBackBtn{background:#24272a;border-color:#3b3f44;color:#f1eeea;box-shadow:0 5px 16px #0003}:root[data-theme="dark"] .nettoBackBtn:hover{background:#2c2f33;border-color:#4d5157}
 :root[data-theme="dark"] .nettoBellBtn,:root[data-theme="dark"] .nettoUserBtn{background:#202225;border-color:#383c41;color:#f5f2ef;box-shadow:0 6px 18px #0003}:root[data-theme="dark"] .nettoBellBtn:hover,:root[data-theme="dark"] .nettoUserBtn:hover{background:#272a2d;border-color:#4b403b}:root[data-theme="dark"] .nettoBellBtn svg{fill:#e9e6e2}:root[data-theme="dark"] .nettoNotifBadge{border-color:#202225}:root[data-theme="dark"] .nettoDrop{background:#1b1d20fa;border-color:#3a3e43;color:#f5f2ef;box-shadow:0 24px 70px #0008}:root[data-theme="dark"] .nettoNavBtn:hover{background:#272a2d}:root[data-theme="dark"] .nettoNavBtn>span:first-child{background:#30241f;color:#ff9a72}:root[data-theme="dark"] .nettoNotifHead,:root[data-theme="dark"] .nettoUserHead{background:linear-gradient(180deg,#1f2124,#1b1d20);border-color:#34383d}:root[data-theme="dark"] .nettoNotifBody span,:root[data-theme="dark"] .nettoUserText small,:root[data-theme="dark"] .nettoUserHead small{color:#aaa5a0}:root[data-theme="dark"] .nettoNotifItem{border-color:#33373b}:root[data-theme="dark"] .nettoNotifItem.manual_edit{background:#1c2637;border-color:#314568}:root[data-theme="dark"] .nettoNotifItem.import_new{background:#183025;border-color:#2d503b}:root[data-theme="dark"] .nettoNotifItem.import_replace{background:#342819;border-color:#574225}:root[data-theme="dark"] .nettoNotifItem.reset_day,:root[data-theme="dark"] .nettoNotifItem.reset_week{background:#38221f;border-color:#5a332d}:root[data-theme="dark"] .nettoNotifItem.password_reset_request{background:#382c1d;border-color:#5b4728}:root[data-theme="dark"] .nettoNotifItem.password_reset_request .nettoNotifIcon{background:#49371f;color:#ffc66e}
...
function notificationIcon(k){return k==='password_reset_request'?'🔑':k==='import_new'?'▦':k==='import_replace'?'↻':(k==='reset_day'||k==='reset_week')?'⌫':'✎'}
...
async function init(){addStyle();if(!window.supabase?.createClient)return;api.client=window.supabase.createClient(URL,KEY);const {data:{session}}=await api.client.auth.getSession();if(!session)return;api.session=session;await refresh();rememberSiteBase();addBackButton();logPageView();bindHomeMark();await loadNotifications();startNotificationsRealtime();startPresence();window.addEventListener('focus',loadNotifications);document.addEventListener('visibilitychange',()=>{if(!document.hidden)loadNotifications()})}
